    ...
    <div className={`navbarContainer ${scrolled && !isOpen ? "scrolled" : ""}`}>
      <div className="logoContainer z-30">
        <Link to="/" onClick={() => setIsOpen(false)} className="navbarText">
          ANA<span className="font">&</span>GEOVANNI
        </Link>
      </div>
      ...
      {isMobile ? (
          ...
          >
            <div className="menu">
              <ul className="lista">
                ...
                <li className={navItemClass('itinerary')}>
                  <button onClick={() => { scrollToSection('itinerary'); setIsOpen(false); }}>
                    Itinerario
                  </button>
                </li>
                <li className={navItemClass('dresscode')}>
                  <button onClick={() => { scrollToSection('dresscode'); setIsOpen(false); }}>
                    Código de Vestimenta
                  </button>
                </li>
                <li className={navItemClass('where')}>
                  <button onClick={() => { scrollToSection('where'); setIsOpen(false); }}>
                    ¿Cuándo y Dónde?
                  </button>
                </li>
        ...
        <div className="desktop-menu">
          <ul className="lista">
            ...
            <li className={navItemClass('itinerary')}>
              <button onClick={() => scrollToSection('itinerary')}>
                Itinerario
              </button>
            </li>
            <li className={navItemClass('dresscode')}>
              <button onClick={() => scrollToSection('dresscode')}>
                Código de Vestimenta
              </button>
            </li>
            <li className={navItemClass('where')}>
              <button onClick={() => scrollToSection('where')}>
                ¿Cuándo y Dónde?
              </button>
            </li>
            <li className={navItemClass('gifts')}>
