...
import Logo from '../../assets/img/etiquetas ap solo letras.png';
...
const HeroSection = () => {
  const mainImg = images[13];
  return (
    <HeroSectionContainer $bg={mainImg.src}>
      <Overlay></Overlay>
      <TextContainer data-aos="zoom-in">
        <StyledLogo src={Logo} />
        <Date>NOS CASAMOS</Date>
        <Subtitle>Ana y Geovanni</Subtitle>
        <Message>05.04.2025</Message>
      </TextContainer>
